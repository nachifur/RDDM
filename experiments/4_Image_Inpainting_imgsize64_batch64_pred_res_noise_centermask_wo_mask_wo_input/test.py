...
if condition:
    ...
    if input_condition:
        ...
        folder = ["/gpfs/home/liujiawei/data-set/program/diffusion/paper/iclr2024/Image-to-Image-Translation/cat.flist",
                  "/gpfs/home/liujiawei/data-set/program/diffusion/paper/iclr2024/Image-to-Image-Translation/male.flist",
                  "/gpfs/home/liujiawei/data-set/program/diffusion/paper/iclr2024/Image-to-Image-Translation/male_test.flist"]
...
if not trainer.accelerator.is_local_main_process:
    ...
    trainer.set_results_folder(
        './results/test_timestep_'+str(sampling_timesteps)+"_100pt_res_noise_eta1_ddpm")
    trainer.test(last=True,sample=True)
